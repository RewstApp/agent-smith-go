...
func setEnvVars(t *testing.T) {
	// Set environment variables specific to Darwin
...
func TestGetDataDirectory(t *testing.T) {
	...
	orgId := "org123"
	expected := filepath.Join("/Library/Application Support", "rewst_remote_agent", orgId)
...
func TestGetServiceName(t *testing.T) {
	orgId := "org123"
	expected := "io.rewst.remote_agent_" + orgId
