...
Copy-Item -Path "./bin/rewst_service_manager.win.exe" -Destination "C:/Program Files/RewstRemoteAgent/$env:REWST_ORG_ID/rewst_service_manager$env:REWST_ORG_ID.win.exe"
